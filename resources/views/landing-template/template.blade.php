        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-4 mx-auto">
                    <img src="{{Storage::URL($navbar[0]->icon)}}" width="100px" alt="">
                    {{$navbar[0]->title}}
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="#about" class="nav-link smoothScroll">{{$navbar[0]->m_about}}</a>
                    </li>
                    <li class="nav-item">
                        <a href="#project" class="nav-link smoothScroll">{{$navbar[0]->m_facility}} & {{$navbar[0]->m_room}}</a>
                    </li>
                    <li class="nav-item">
                        <a href="blog.html" class="nav-link">{{$navbar[0]->m_reservation}}</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                          <div class="hero-image" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <img src="{{asset('assets/images/receptionist.png')}}" class="img-fluid" alt="working girl">
                          </div>
                        </div>
