...
<?php endif; ?>
    ...
    <span id="<?php echo e($this->id); ?>.table.selection.indicator.record-count.<?php echo e($allSelectableRecordsCount); ?>" x-show="<?php echo e($allSelectableRecordsCount); ?> !== selectedRecords.length">
...
<?php /**PATH C:\laragon\www\TugasTekpro\hotel\vendor\filament\tables\src\/../resources/views/components/selection-indicator.blade.php ENDPATH**/ ?>