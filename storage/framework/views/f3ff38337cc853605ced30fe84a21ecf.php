...
} elseif ($_instance->childHasBeenRendered('AhRkvEP')) {
    $componentId = $_instance->getRenderedChildComponentId('AhRkvEP');
    $componentTag = $_instance->getRenderedChildComponentTagName('AhRkvEP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AhRkvEP');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('AhRkvEP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\laragon\www\TugasTekpro\hotel\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>