...
} elseif ($_instance->childHasBeenRendered('W2z57aF')) {
    $componentId = $_instance->getRenderedChildComponentId('W2z57aF');
    $componentTag = $_instance->getRenderedChildComponentTagName('W2z57aF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('W2z57aF');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('W2z57aF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('WpKYaVk')) {
    $componentId = $_instance->getRenderedChildComponentId('WpKYaVk');
    $componentTag = $_instance->getRenderedChildComponentTagName('WpKYaVk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WpKYaVk');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('WpKYaVk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\laragon\www\TugasTekpro\hotel\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>